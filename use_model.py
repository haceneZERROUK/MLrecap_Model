...
df_final_2 = pd.read_json('new_film.json')
...
def use_model():
    ...
    df_final_2['prediction'] = result

    df_final_2.sort_values(by = 'prediction', ascending=False).head(10).to_csv('top_movies.csv')
    print(df_final_2.sort_values(by = 'prediction', ascending=False).head(10))
